...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_border = QtGui.QFrame(MainWindow)
        self.frame_border.setGeometry(QtCore.QRect(0, 13, 1280, 707))
        self.frame_border.setStyleSheet("")
        self.frame_mainImage = QtGui.QFrame(MainWindow)
        self.frame_mainImage.setGeometry(QtCore.QRect(15, 28, 1270, 700))
        self.frame_boardImage = QtGui.QFrame(MainWindow)
        self.frame_boardImage.setGeometry(QtCore.QRect(280, 0, 1000, 1000))
        self.frame_boardImage.setStyleSheet("background-image: url(Copy of Initial Board.png)")
        self.frame_gold = QtGui.QFrame(MainWindow)
        self.frame_gold.setGeometry(QtCore.QRect(0, 0, 275, 1000))
        self.frame_gold.setStyleSheet("background-color: rgb(202, 186, 12)")
        self.frame_gold.lower()
        self.frame_black = QtGui.QFrame(MainWindow)
        ...
        self.button_newGame.setGeometry(QtCore.QRect(20, 300, 241, 71))
        ...
        self.button_mainMenu.setGeometry(QtCore.QRect(1140, 20, 121, 31))
        ...
        self.frame_diceResult.setGeometry(QtCore.QRect(740, 480, 481, 121))
        ...
        self.spotText.setStyleSheet("font: bol")
        self.actionText = QtGui.QLabel(self.frame_currentPlayerInfo)
        #action_font = QtGui.QFont("Monospace", 11)
        #action_font.setStyle(QtGui.QFont.StyleOblique)
        self.actionText.setStyleSheet("font: italic bold 16pt Serif")
        self.actionText.setGeometry(QtCore.QRect(620, 400, 570, 60))
        self.actionText.setText("")
        self.actionText.setObjectName("actionText")
        self.actionText.setWordWrap(True)
        self.button_locationLogo = QtGui.QPushButton(MainWindow)
        self.button_locationLogo.setEnabled(False)
        self.button_locationLogo.setVisible(False)
        self.button_locationLogo.setGeometry(QtCore.QRect(510, 50, 100, 100))
        self.button_locationLogo.setText("")
        self.locationName = QtGui.QLabel(self.centralwidget)
        self.locationName.setGeometry(QtCore.QRect(625, 50, 700, 75))
        self.locationName.setAlignment(QtCore.Qt.AlignVCenter)
        self.locationName.setStyleSheet("font: 75 40pt Serif")
        self.locationName.setText("")
        self.locationName.setObjectName("locationName")
        self.chanceCard = QtGui.QLabel(self.centralwidget)
        self.chanceCard.setGeometry(QtCore.QRect(675, 160, 390, 225))
        self.chanceCard.setAlignment(QtCore.Qt.AlignVCenter)
        self.chanceCard.setStyleSheet("font: italic 14pt Serif")
        self.chanceCard.setText("")
        self.chanceCard.setWordWrap(True)
        self.chanceCard.setObjectName("chanceCard")
