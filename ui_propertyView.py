...
class Ui_propertyView(object):
    def setupUi(self, propertyView):
        ...
        self.frame_brickImage = QtGui.QFrame(propertyView)
        self.frame_brickImage.setGeometry(QtCore.QRect(0, 0, 1300, 800))
        ...
        self.frame_playerInfo.setStyleSheet("background-color: rgb(255,255,255)")
